# คำสั่งรับข้อความ string ทางแป้นพิมพ์ ใช้ฟังก์ชัน input{}
#****** ตัวแปร variable คือ ข้อที่ Dev ตั้งขึ้นมาเอง (ต้องเป้นไปตามกฎการตั้งชื่อ) เอาไว้เก็บข้อมูลที่เกิดขึ้นในโปรแกรม
...
print('คุณเกิดในปี {}'.format(year_born)+'ตอนนี้คุณออายุ {}'.format(2568 - int(year_born)))
print('--------------------')